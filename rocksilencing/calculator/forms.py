...
class Scale_Calculator_form_1(forms.Form):
    ...
    Cl_1 = forms.FloatField(label = "", widget = forms.NumberInput(
        attrs = {'class':"input","oninput":"limitLength(event)","for":"Cl_1","type":"text", "style":"background: #292e3c;"}))
    SO4_1  = forms.FloatField(label="", widget = forms.NumberInput(
        attrs = {'class':"input","oninput":"limitLength(event)","for":"SO4_1","type":"text", "style":"background: #363A47;"}))
    HCO3_1 = forms.FloatField(label = '', widget= forms.NumberInput(
        attrs = {'class':"input","oninput":"limitLength(event)","for":"Cl_1","type":"text", "style":"background: #292e3c;"}))
    Ca_1 = forms.FloatField(label = '', widget= forms.NumberInput(
        attrs = {'class':"input","oninput":"limitLength(event)","for":"Ca_1","type":"text", "style":"background: #363A47;"}))
    Mg_1 = forms.FloatField(label="", widget=forms.NumberInput(
        attrs = {'class':"input","oninput":"limitLength(event)","for":"Mg_1","type":"text", "style":"background: #292e3c;"}))
    Na_1 = forms.FloatField(label="", widget=forms.NumberInput(
        attrs = {'class':"input","oninput":"limitLength(event)","for":"Na_1","type":"text", "style":"background: #363A47;"}))
    Ba_1 = forms.FloatField(label="",widget=forms.NumberInput(
        attrs={'class': "input","oninput":"limitLength(event)","for":"Ba_1","type":"text", "style":"background: #292e3c;"}))
    Sr_1 = forms.FloatField(label="",widget=forms.NumberInput(
        attrs={'class': "input","oninput":"limitLength(event)","for":"Sr_1","type":"text", "style":"background:  #363A47;"}))
    pH_1 = forms.FloatField(label='',widget=forms.NumberInput(
        attrs={"type":"text","oninput":"limitLength(event)", "id":"ph_1", "style":"width: 60px border-radius: 4px; background: rgba(255, 255, 255, 0.06); border: none; outline: none; color: #fff;"}))
    ro_1 = forms.FloatField(label='', widget=forms.NumberInput(
        attrs={"type":"text","oninput":"limitLength(event)", "id":"density_1" ,"style":"width: 60px; border-radius: 4px; background: rgba(255, 255, 255, 0.06); border: none; outline: none; color: #fff;"}))
    ...
    Temperature = forms.FloatField (label='',widget=forms.NumberInput(
        attrs={"type":"text","oninput":"limitLength(event)", "id":"ph_1", "style":"width: 60px border-radius: 4px; "
...
class Scale_Calculator_form_2(forms.Form):
    ...
    Cl_1_another = forms.FloatField(label="", widget=forms.NumberInput(
        attrs={'class': "input","oninput":"limitLength(event)", "step":"0.0001", "for": "Cl_1", "type": "text", "style": "background: #292e3c;"}))
    ...
    Cl_2_another = forms.FloatField(label="", widget=forms.NumberInput(
        attrs={'class': "input","oninput":"limitLength(event)", "for": "Cl_2", "type": "text", "style": "background: #292e3c;"}))
    SO4_2_another = forms.FloatField(label="", widget=forms.NumberInput(
        attrs={'class': "input","oninput":"limitLength(event)", "for": "SO4_2", "type": "text", "style": "background: #363A47;"}))
    HCO3_2_another = forms.FloatField(label="", widget=forms.NumberInput(
        attrs={'class': "input","oninput":"limitLength(event)", "for": "HCO3_2", "type": "text", "style": "background: #292e3c;"}))
    Ca_2_another = forms.FloatField(label="", widget=forms.NumberInput(
        attrs={'class': "input","oninput":"limitLength(event)", "for": "Ca_2", "type": "text", "style": "background: #363A47;"}))
    Mg_2_another = forms.FloatField(label="", widget=forms.NumberInput(
        attrs={'class': "input","oninput":"limitLength(event)", "for": "Mg_2", "type": "text", "style": "background: #292e3c;"}))
    Na_2_another = forms.FloatField(label="", widget=forms.NumberInput(
        attrs={'class': "input","oninput":"limitLength(event)", "for": "Na_2", "type": "text", "style": "background: #363A47;"}))
    Ba_2_another = forms.FloatField(label="", widget=forms.NumberInput(
        attrs={'class': "input","oninput":"limitLength(event)", "for": "Ba_2", "type": "text", "style": "background: #292e3c;"}))
    Sr_2_another = forms.FloatField(label="", widget=forms.NumberInput(
        attrs={'class': "input","oninput":"limitLength(event)", "for": "Sr_2", "type": "text", "style": "background: #363A47;"}))